...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TERRAIN_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TERRAINS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TERRAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TERRAIN actions', async () => {
      const expectedActions = [
        {
