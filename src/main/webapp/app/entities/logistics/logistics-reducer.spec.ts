...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOGISTICS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_LOGISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_LOGISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LOGISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LOGISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LOGISTICS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LOGISTICS actions', async () => {
      const expectedActions = [
        {
