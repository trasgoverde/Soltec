...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HUMANRESOURCES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HUMANRESOURCES actions', async () => {
      const expectedActions = [
        {
