...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESOURCES_LIST actions', async () => {
    ...
    it('dispatches SEARCH_RESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_RESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RESOURCES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RESOURCES actions', async () => {
      const expectedActions = [
        {
