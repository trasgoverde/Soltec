...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEAMS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_TEAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_TEAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TEAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TEAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TEAMS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TEAMS actions', async () => {
      const expectedActions = [
        {
