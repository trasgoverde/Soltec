...
export const searchEntities = createAsyncThunk('teams/search_entity', async ({ query, page, size, sort }: IQueryParams) => {
...
export const createEntity = createAsyncThunk(
  ...
  async (entity: ITeams, thunkAPI) => {
    return axios.post<ITeams>(apiUrl, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const updateEntity = createAsyncThunk(
  'teams/update_entity',
  async (entity: ITeams, thunkAPI) => {
    return axios.put<ITeams>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const partialUpdateEntity = createAsyncThunk(
  ...
  async (entity: ITeams, thunkAPI) => {
    return axios.patch<ITeams>(`${apiUrl}/${entity.id}`, cleanEntity(entity));
  },
  { serializeError: serializeAxiosError }
);
...
export const deleteEntity = createAsyncThunk(
  ...
  async (id: string | number, thunkAPI) => {
    const requestUrl = `${apiUrl}/${id}`;
    return await axios.delete<ITeams>(requestUrl);
  },
  { serializeError: serializeAxiosError }
);
