...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISMANTLING_LIST actions', async () => {
    ...
    it('dispatches SEARCH_DISMANTLINGS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_DISMANTLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISMANTLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISMANTLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISMANTLING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISMANTLING actions', async () => {
      const expectedActions = [
        {
