...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MACHINERY_LIST actions', async () => {
    ...
    it('dispatches SEARCH_MACHINERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_MACHINERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_MACHINERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_MACHINERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_MACHINERY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_MACHINERY actions', async () => {
      const expectedActions = [
        {
