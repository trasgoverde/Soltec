...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROVIDERS_LIST actions', async () => {
    ...
    it('dispatches SEARCH_PROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches FETCH_PROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PROVIDERS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PROVIDERS actions', async () => {
      const expectedActions = [
        {
